...
public abstract class Animal {
	...
	public String toString() {
		return "Animal [nome=" + nome + ", codigo=" + codigo + ", tipo=" + getTipo() 
				+ ", dataNascimento=" + dataNascimento + ", tamanho="
				+ tamanho + ", ehBarulhento=" + ehBarulhento + ", ehManso=" + ehManso + ", cor=" + cor + ", sexo="
				+ sexo + ", temPedigree=" + temPedigree + ", estahComVacinasEmDia=" + estahComVacinasEmDia
				+ ", estahCastrado=" + estahCastrado + ", detalhes=" + detalhes + ", tipoAlimentacao=" + tipoAlimentacao
				+ "]";
	}
